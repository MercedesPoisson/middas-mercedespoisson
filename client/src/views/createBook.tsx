        ...
        <div>
            <form action="">
                <div>
                  ...
                  <Input placeholder={"ingresa el título de tu libro"} name={"title"} />  
                </div>
                <div>
                ...
                <InputNames>{"Año de Publicación"}</InputNames>
                  <Input placeholder={"ingresa el año en que se publicó"} name={"year"} />
                  <InputNames>{"Genero"}</InputNames>
                  <SelectGenre />  
                </div>
                <div className="mt-2">
                    <Button icon={"check"} to={"/"}>{"confirmar"}</Button>
                </div>
